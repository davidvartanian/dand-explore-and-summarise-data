...
plot.volatile.acidity <- ggplot(aes(x = volatile.acidity), data = data) +
  geom_histogram(aes(colour = I('#CC9933')), bins = 20) +
  xlab('Acetic Acid (g/dm³)')

plot.volatile.acidity.outliers.box <- ggplot(aes(x = 1, y = volatile.acidity), 
                                         data = data) +
  geom_boxplot(colour = 'blue', outlier.shape = 1, outlier.colour = 'red') +
  geom_jitter(aes(x = 1, y = volatile.acidity), alpha = 0.3) +
  labs(x = '', y = 'Acetic Acid (g/dm³)', 
       title = 'Acetic Acid Outliers')

# fixed.acidity
plot.fixed.acidity <- ggplot(aes(x = fixed.acidity), data = data) +
  geom_histogram(aes(colour = I('#99CCFF')), bins = 20) +
  xlab('Tartaric Acid (g/dm³)')

plot.fixed.acidity.outliers.box <- ggplot(aes(x = 1, y = fixed.acidity), 
                                      data = data) +
  geom_boxplot(colour = 'blue', outlier.shape = 1, outlier.colour = 'red') +
  geom_jitter(aes(x = 1, y = fixed.acidity), alpha = 0.3) +
  labs(x = '', y = 'Tartaric Acid (g/dm³)', title = 'Tartaric Acid Outliers')

plot.total.sulfur.dioxide <- ggplot(aes(x = total.sulfur.dioxide), 
                                    data = data) +
  geom_histogram(aes(colour = I('#00DD99')), bins = 20) +
  xlab('Total Sulphure Dioxide (mg/dm³)')

plot.total.sulfur.dioxide.outliers.box <- ggplot(aes(x = 1, 
                                                 y = total.sulfur.dioxide), 
                                             data = data) +
  geom_boxplot(colour = 'blue', outlier.shape = 1, outlier.colour = 'red') +
  geom_jitter(aes(x = 1, y = total.sulfur.dioxide), alpha = 0.3) +
  labs(x = '', y = 'Total Sulphure Dioxide (mg/dm³)', 
       title = 'Total Sulphure Dioxide Outliers')

plot.alcohol <- ggplot(aes(x = alcohol), data = data) +
  geom_histogram(aes(colour = I('#FF3366')), bins = 10) +
  xlab('Alcohol (%)')

plot.alcohol.outliers.box <- ggplot(aes(x = 1, y = alcohol), data = data) +
  geom_boxplot(colour = 'blue', outlier.shape = 1, outlier.colour = 'red') +
...
plot.chlorides <- ggplot(aes(x = chlorides), data = data) +
  geom_histogram(aes(colour = I('#CCFF00')), bins = 10) +
  xlab('Sodium Chloride (g/dm³)')

plot.chlorides.outliers.box <- ggplot(aes(x = 1, y = chlorides), data = data) +
  geom_boxplot(colour = 'blue', outlier.shape = 1, outlier.colour = 'red') +
  geom_jitter(aes(x = 1, y = chlorides), alpha = 0.3) +
  labs(x = '', y = 'Sodium Chloride (g/dm³)', 
       title = 'Sodium Chloride Outliers')

plot.residual.sugar <- ggplot(aes(x = residual.sugar), data = data) +
  geom_histogram(aes(colour = I('#6688CC')), bins = 20) +
  xlab('Residual Sugar (g/dm³)')

plot.residual.sugar.outliers.box <- ggplot(aes(x = 1, y = residual.sugar), 
                                       data = data) +
  geom_boxplot(colour = 'blue', outlier.shape = 1, outlier.colour = 'red') +
  geom_jitter(aes(x = 1, y = residual.sugar), alpha = 0.3) +
  labs(x = '', y = 'Residual Sugar (g/dm³)', 
       title = 'Residual Sugar Outliers')

plot.pH <- ggplot(aes(x = pH), data = data) +
  geom_histogram(aes(colour = I('#CC00CC')), bins = 20) +
  xlab('pH')

plot.pH.outliers.box <- ggplot(aes(x = 1, y = pH), data = data) +
  geom_boxplot(colour = 'blue', outlier.shape = 1, outlier.colour = 'red') +
  geom_jitter(aes(x = 1, y = pH), alpha = 0.3) +
  labs(x = '', y = 'pH', title = 'pH Outliers')

plot.sulphates <- ggplot(aes(x = sulphates), data = data) +
  geom_histogram(aes(colour = I('#33DDDD')), bins = 10) +
  xlab('Potassium Sulphate (g/dm³)')

plot.sulphates.outliers.box <- ggplot(aes(x = 1, y = sulphates), data = data) +
  geom_boxplot(colour = 'blue', outlier.shape = 1, outlier.colour = 'red') +
  geom_jitter(aes(x = 1, y = sulphates), alpha = 0.3) +
  labs(x = '', y = 'Potassium Sulphate (g/dm³)', 
       title = 'Potassium Sulphate Outliers')

plot.density <- ggplot(aes(x = density), data = data) +
  geom_histogram(aes(colour = I('#91C0F9')), bins = 20) +
  xlab('Density of water')

plot.density.outliers.box <- ggplot(aes(x = 1, y = density), data = data) +
  geom_boxplot(colour = 'blue', outlier.shape = 1, outlier.colour = 'red') +
...
ggplot(aes(x = factor(quality), y = alcohol), data = data) +
  ...
  labs(x = 'Quality', y = 'Alcohol (%)', title = 'Alcohol level by Quality')
```
...
ggplot(aes(x = factor(quality), y = fixed.acidity), data = data) +
  geom_jitter(alpha = 0.3) +
  geom_boxplot(alpha = 0.5, colour = 'blue') +
  labs(x = 'Quality', y = 'Tartaric Acid (g/dm³)', 
       title = 'Tartaric Acid level by Quality')
```
...
ggplot(aes(x = factor(quality), y = density), data = data) +
  geom_jitter(alpha = 0.3) +
  geom_boxplot(alpha = 0.5, colour = 'blue') +
  labs(x = 'Quality', y = 'Density (g/cm³)', 
       title = 'Density level by Quality')
```
